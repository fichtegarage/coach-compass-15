 ...
 *
 * Coach-seitiger Tab in ClientDetailPage.
 * Zeigt: Trainingshistorie, PR-Board, Volumen-Trend.
 */
...
import { Loader2, Trophy, ChevronDown, ChevronUp, Dumbbell, Zap, Clock, Star } from 'lucide-react';
